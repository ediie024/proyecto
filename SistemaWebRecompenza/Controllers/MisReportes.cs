...
{
    public class MisReportes : Controller
    {
        private readonly ProyectoContext _context;

        public MisReportes(ProyectoContext _context)
        {
        ...
        public IActionResult Index(String busqueda="")
        {
            ...
            var reportess = _context.Reportes.Where(o=>o.IdUSuario==user.Id).ToList().Select(o => o.Id).Intersect(IdOBjetos).ToList();
